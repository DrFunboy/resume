...
return [
    ...
    'iunique_without_digits' => 'Такое значение поля :attribute уже существует.',
    ...
    'attributes'           => [
        ...
        'clients.*.inn' => 'ИНН заказчика',
        'clients.*.name' => 'Название заказчика',
        'type_id' => 'Тип',
        'status_id' => 'Статус',
        'requirements_experience_years' => 'На рынке (лет)',
        'custom_contact_name' => 'ФИО контактного лица',
        'custom_contact_email' => 'Email контактного лица',
        'custom_contact_phone' => 'Телефон контактного лица',
        'regions' => 'Регионы',
        'technologies' => 'Стек технологий',
        'technologies.*' => 'Стек технологий',
        'requests_finished_at' => 'Прием предложений до',
        'realisation_finished_at' => 'Срок реализации до',
        'questions' => 'Вопросы',
        'task' => 'Задача',
        'link' => 'Ссылка',
        'cover' => 'Обложка',
        'industries' => 'Отрасли',
        'imports' => 'Импортные продукты',
        'registry_software_number' => '№ в реестре',
        'remove.documents' => 'Документы на удаление',
        'remove.screenshots' => 'Скриншоты на удаление',
        'name_short' => 'Фирменное название',
        'name_full' => 'Полное название',
        'start_year' => 'Год основания',
        'contact_person_full_name' => 'ФИО контактного лица',
        'contact_person_position' => 'Должность контактного лица',
        'contact_person_phones' => 'Телефоны контактного лица',
